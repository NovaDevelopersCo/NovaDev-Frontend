...
const UserInfo: FC<IUserInfo> = ({ token, t }) => {
  ...
  //
  useEffect(() => {
    UserInfoAPI.getUserData(token, user, setUser)
      .then(() => {
  ...
  const onFinish = (e: React.FormEvent<HTMLFormElement>): void => {
    e.preventDefault()
    UserInfoAPI.editUserData(token, user)
      .then(() => {
        console.log('Done')
      })
      .catch((e) => openNotification(e, 'topRight'))
  ...
  //
  useEffect(() => {
    UserInfoAPI.getUserTeam(token, userTeam, setUserTeam)
      .then(() => {
        console.log('Выполнено!')
      })
      .catch((e) => openNotification(e, 'topRight'))
      ...
      {isEditing ? (
        <div className='flex flex-col mt-4'>
          ...
          <Form className='flex flex-col gap-6' onFinish={onFinish}>
            <Form.Item
              label={t('user-id')}
              rules={[{ required: false, message: t('enter-your-id') }]}
            >
              <Input className='w-64' type='number' value={user.id} />
            </Form.Item>
            <Form.Item
              label={t('user-role-title')}
              rules={[{ required: false, message: t('enter-your-role-title') }]}
            >
            ...
            <div className='border-2 border-black rounded-md pl-2'>
              ...
              <Form.Item
                label={t('user-image-url')}
                rules={[
                  { required: false, message: t('enter-your-image-url') }
                ]}
              >
                <Input className='w-64' type='text' value={user.info.image} />
              </Form.Item>
              <Form.Item
                label={t('user-public-nickname')}
                rules={[
                  { required: false, message: t('enter-your-public-nickname') }
                ]}
              >
                <Input
                  className='w-64'
                  type='text'
                  value={user.info.public_nickname}
                />
              </Form.Item>
              <Form.Item
                label={t('user-full-name')}
                rules={[
                  { required: false, message: t('enter-your-full-name') }
                ]}
              >
                <Input
                  className='w-64'
              ...
              <Form.Item
                label={t('user-email')}
                rules={[{ required: false, message: t('enter-your-email') }]}
              >
                <Input className='w-64' type='text' value={user.info.image} />
              </Form.Item>
              <Form.Item
                label={t('user-phone')}
                rules={[{ required: false, message: t('enter-your-phone') }]}
              >
                <Input className='w-64' type='number' value={user.info.email} />
              </Form.Item>
              <Form.Item
                label={t('user-github')}
                rules={[{ required: false, message: t('enter-your-github') }]}
              >
                <Input className='w-64' type='text' value={user.info.github} />
              </Form.Item>
              <Form.Item
                label={t('user-payment-info')}
                rules={[
                  { required: false, message: t('enter-your-payment-info') }
                ]}
              >
                <Input
                  className='w-64'
                  type='text'
                  value={user.info.payment_info}
                />
              </Form.Item>
              <Form.Item
                label={t('user-tg')}
                rules={[{ required: false, message: t('enter-your-tg') }]}
              >
            ...
            <div className='border-2 border-black rounded-md pl-2'>
              ...
              <Form.Item
                label={t('user-project-id')}
                rules={[
                  { required: false, message: t('enter-your-project-id') }
                ]}
              >
                <Input
                  className='w-64'
              ...
              <Form.Item
                label={t('user-project-title')}
                rules={[
                  { required: false, message: t('enter-your-project-title') }
                ]}
              >
                <Input
                  className='w-64'
            ...
            <div className='flex justify-center'>
              <Button
                className='flex justify-center items-center text-lg w-28 mt-5'
                htmlType='submit'
              >
