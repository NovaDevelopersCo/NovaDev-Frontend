...
const DeleteUserModal: FC<IDeleteUserModalProps> = ({ onCancel, token, userId }) => {
    ...
    return <Modal title="User delete Modal" open={!!userId} onCancel={onCancel} footer={[<Button key="cancel" onClick={onCancel}>{t('cancel')}</Button>]}>
